...
HD_PWD='C:/Users/deshr/OneDrive/Desktop/Mini Project Final/Final/Final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Image_Processing_Final.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Image_Processing_Final.tcl
