...
HD_PWD='C:/Users/deshr/OneDrive/Desktop/Mini Project Final/Final/Final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Image_Processing_Final.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Image_Processing_Final.tcl -notrace
